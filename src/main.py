...
from presentation.bank_cli import BankCLI, run_registration, show_balance, run_deposit, run_withdrawal
...
if __name__ == "__main__":
    ...
    cli = BankCLI("--- Top-Bank CLI ---")
    cli.add_option("1", "Criar Conta", run_registration)
    cli.add_option("2", "Consultar Saldo", show_balance)
